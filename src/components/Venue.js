        ...
        <Fade triggerOnce>
            <div className='container rounded-xl mx-auto px-4 pt-4 pb-6 mb-16' style={{ width: '85%'}}>
                ...
                <p className="my-2 mt-4 text-lg font-semibold text-gray-900">STEP 1: Getting to Village Hotel Sentosa</p>
                    ...
                    <li>By Car: Parking lots are available and based on first-come-first-served basis. (Complimentary parking coupons are provided for staff who have opted-in to the Staycation at Village Hotel Sentosa)</li>
