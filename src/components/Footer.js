...
<a className="flex flex-row" href="https://www.linkedin.com/company/sttgdc">@ST Telemedia Global Data Centre!</a><br/><br/>#BuiltForFun #LifeatSTTGDC #EnablingOurDigitalFuture</p>
                </div>
                <br/>
