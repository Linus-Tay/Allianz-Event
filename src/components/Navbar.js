...
const Navbar = () => {
    ...
    <div className='header'>
        ...
        <div className="flex lg:order-2">
            <Linkto to="registration" className="sttelemedia bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4text-zinc-600 py-2 px-2 py-1 text-white mr-2 text-center">Register</Linkto>
