...
const Navbar = () => {
    ...
    <div className='header'>
        ...
        <div className="flex md:order-2">
            <button className="md: text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm md:px-4 md:py-2 px-2 py-1 text-center md:mr-0 ">Register</button>
