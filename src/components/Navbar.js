...
const Navbar = () => {
    ...
    <div className='header'>
        ...
        <Link to="hero" className="cursor-pointer flex items-center">
            <img src={Logo} className="h-8 md:h-10 md:h-18 md:mr-3" alt="STTelemedia" />
        </Link>
        <div className="flex order-2">
            ...
            <span className='w-28 text-xs text-neutral-600 mt-1' style={{marginRight:"-8px"}}>Registration closes on 23 June 2023</span>
            <button onClick={ToggleSidebar}  style={{marginRight:"-10px"}} data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 text-sm rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 " aria-controls="navbar-sticky" aria-expanded="false">
